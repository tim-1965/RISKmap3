      ...
      const html = ensureMinHeight(`
        <div style="display:flex;flex-direction:column;gap:16px;">
          ...
          <div style="background-color:#fef3c7;border:1px solid #f59e0b;border-radius:12px;padding:20px;line-height:1.6;color:#92400e;font-size:14px;">
            There are six labour rights due diligence tools on this panel. In reverse order, you will find two forms of <p><strong> SAQ <strong><p>, self-assessment questionnaires. This refers to a much-used system where suppliers are sent questionnaires on their policies and procedures relating to labour rights in their workplaces and supplier confirm what they do. SAQ with evidence means the questionnaire has to be supported with evidence (eg: copies of the policies). You will find two forms of <p><strong> social audit <strong><p>: unannounced and announced/self-arranged. In a social audit, a trained auditor visits a workplace and typically spends time with management asking a standard set of questions (eg: conforming to the SMETA standard), compiling answers, asking for evidence to support, and sometimes also interviews workers. Unannounced audits are seldom used, most audits are announced in advance or self-arranged by suppliers. You will find two forms of <p><strong> worker voice <strong><p>: survey and continuous. A survey is when a sample of workers (or sometimes all workers) are asked questions about how they are treated with the results compiled into a report. There will be a date or few dates when the survey is conducted, with the report available after. With continuous worker voice, workers report all the time and results are in real-time, typically presented on interactive dashboards - it is a continuous connection with workers that usually covers all-the-workers, all-the-time.
            </div>
